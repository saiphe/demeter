class MoviesController < ApplicationController
  ...
  def index
    ...
    @movies = @q.result(distinct: true).sort_by {|w| w.title.sub(/^the /i, "")}
  end
  ...
  def destroy
    @movie.destroy
    respond_to do |format|
      format.html { redirect_to movies_url, notice: @movie.title + ' was deleted.' }
  ...
  private
    ...
    def movie_params
      params.require(:movie).permit(:title,:disc)
    end
end
